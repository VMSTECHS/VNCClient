...
//            bmCursor = BitmapFactory.decodeResource(getResources(), R.drawable.fab_icon);
//            if (bmCursor != null) {
...
//        }
    ...
    void initializeVncCanvas(ConnectionBean bean, final Runnable setModes) {
        ...
        Thread t = new Thread() {
            public void run() {
                try {
                    Log.e("Credentials--", "Username--" + connection.getUserName() + " , Password-- " + connection.getPassword());
                    connectAndAuthenticate(connection.getUserName(), connection.getPassword());
                    //connectAndAuthenticate("qamar@vmstechs.com",connection.getPassword());
    ...
    void connectAndAuthenticate(String us, String pw) throws Exception {
        ...
        Log.e("Credentials22--", "Username--" + connection.getUserName() + " , Password-- " + connection.getPassword());
        ...
        switch (authType) {
            ...
            case RfbProto.AuthVNC:
                Log.e("Credentials33--", "Username--" + connection.getUserName() + " , Password-- " + connection.getPassword());
    ...
    //----To hide the external mouse pointer icon---
    @TargetApi(24)
    @Override
        ...
        if (rfb != null && rfb.inNormalProtocol) {
            ...
            switch (keyCode) {
                ...
                case KeyEvent.KEYCODE_F12:
                    key = keyCode - KeyEvent.KEYCODE_F1 + 0xffbe;
                    break;
                default:
